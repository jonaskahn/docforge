...
|---|---|---|
| C4 | context, container, component, component-evidence | Components state responsibility, technology, directional relationships, and public contracts. At component-evidence, material claims cite `path#Lx-Ly @ <blob>`. Never write C4 Level-4 prose or class diagrams. |
...
| PROV | core, expanded, qualified | This release projects only core relations from provenance 2.0. Expanded and qualified relations require a schema ADR. |
