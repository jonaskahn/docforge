...
Owned policy prose. Each file is the single authority for one cross-cutting
concern; workflows link here instead of repeating the rule.
...
live under `content/<group>/contracts/`), no workflow procedure (that lives
under `workflows/`).
