...
the compatibility range with host versions. For each contribution/extension
point: what it lets an integrator do, its permission scope, and the
sandbox boundary — what it cannot reach. State failure behavior when the
