...
- `claude-local-md.md` — Compact entry points, verified commands, precedence, safe links to owning agent views → [claude-local-md.md](claude-local-md.md)
- `claude-md.md` — Compact entry points, verified commands, precedence, safe links to owning agent views → [claude-md.md](claude-md.md)
- `claude-settings.json` — Compact entry points, verified commands, precedence, safe links to owning agent views → [claude-settings.json](claude-settings.json)
