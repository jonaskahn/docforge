...
This is the smallest useful slice of setup-guide.md's how-to discipline
...
Do not duplicate setup-guide.md's configuration, troubleshooting, or
alternate-path content; link to it for anything beyond the first result.
End with one or two "what next" links (setup-guide.md for full install,
product-overview.md for what this does) — never end on a command with no
stated outcome.
