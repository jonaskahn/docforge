...
from runtime.common._util import fail, read_json
from runtime.common.provenance_frontmatter import emit_yaml, scaffold_provenance
...
def write_communities_summary(repo: Path, export_path: Path) -> Path:
    ...
    from runtime.graph.graph_storage import ensure_tmp_dir_gitignored
