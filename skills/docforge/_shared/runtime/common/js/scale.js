...
// Pass `files` and/or `detections` when the caller already has them — both
// derive from the same single `inventory(repo)` walk.
function computeScale(repo, files = null, detections = null) {
