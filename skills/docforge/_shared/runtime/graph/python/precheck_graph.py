...
fit documented in references/graph/graph-sources.md.
...
def print_flow_remediation(repo: Path) -> None:
    ...
    print("    python runtime/cli/python/derive_flow_graph.py prepare --repo <path>")
    print("    # dispatch the Docforge flow analyzer on the emitted context, then")
    print("    python runtime/cli/python/derive_flow_graph.py write --repo <path> --analysis <analysis.json>")
