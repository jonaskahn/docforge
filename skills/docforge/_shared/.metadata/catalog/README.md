...
133 document records across 12 groups. Category indexes are generated views; `index.json` and each record file remain authoritative. Regenerate these README.md views with `generate_indexes --write`; never edit them directly.
