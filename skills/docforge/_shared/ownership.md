...
- **Two Special-File Sets**: The runtime maintains two distinct special-file sets defined in [`runtime/common/special_files`](runtime/common/special_files.py):
  ...
  - `SPECIAL_DOC_OUTPUTS` (`{"AGENTS.md", "CLAUDE.md", "CLAUDE.local.md"}`): materialized output doc filenames that bypass standard linting and scaffolding constraints (`scaffold_docs`, `lint_document`, `migrate_metadata`).
