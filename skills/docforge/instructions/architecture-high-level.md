...
that order — a reader should be able to draw the box diagram from the prose alone. Prefer
one small diagram per section, only when it clarifies relationships among three or more
blocks; a diagram for two boxes and one arrow is decoration. Name responsibilities with
