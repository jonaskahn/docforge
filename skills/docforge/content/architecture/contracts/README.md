...
Content contract files owned by the `architecture` group.
...
- `concept.md` — One durable concept, responsibility, relationships, invariants, failure boundaries → [concept.md](concept.md)
...
- `dataset.md` — Dataset identity, producers/consumers, schema ownership, freshness/retention, failure/recovery → [dataset.md](dataset.md)
