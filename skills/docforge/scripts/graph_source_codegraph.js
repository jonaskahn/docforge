 ...
 * references/graph-source-codegraph.md.
 *
...
// Lines telling the user how to produce or read the CodeGraph index. The
...
function setupHint(repo, _gap) {
  ...
  return [
    ...
    "  If it is not listed at all: ask the user to run `codegraph install` " +
      ...
      "back to (see references/graph-source-codegraph.md).",
  ];
}
