 ...
 *
 * So this module is pure detection. See references/graph-source-gitnexus.md for
 * the read recipes and references/graph-sources.md for the capability dispatch.
 *
...
function setupHint(repo, gap) {
  ...
  return [
    "GitNexus index present and current — the ladybug DB (.gitnexus/lbug) is " +
      ...
      "scripts/graph_source_gitnexus_reader.js (references/graph-source-gitnexus.md).",
  ];
}
