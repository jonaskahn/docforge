...
runtime/cli/python/graph_source_gitnexus_reader.py — see references/graph/graph-sources.md for
the read dispatch.
    ...
    if path is None:
        ...
        if path is None:
            sys.exit("No JSON code graph found in $PROJECT_ROOT/.ua/ or "
                     ...
                     "it via the gitnexus MCP or runtime/cli/python/graph_source_gitnexus_reader.py "
