...
Content contract files owned by the `reference` group.
...
- `rate-limits.md` — Public surface, inputs/outputs, auth contract, limits, errors, compatibility source → [rate-limits.md](rate-limits.md)
